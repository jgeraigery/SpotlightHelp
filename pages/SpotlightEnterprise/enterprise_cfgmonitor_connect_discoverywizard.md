...
## SQL Server Display Name
The SQL Server display name can be entered post import via [SQL Server Connection Properties][sqlserver_connect_details]. The SQL Server display name cannot be entered via file import and the Connection Discovery Wizard.
