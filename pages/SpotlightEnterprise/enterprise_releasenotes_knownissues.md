...
**Spotlight Cloud** - On the Configure \| Spotlight Cloud page, the organization id may be displayed instead of the email address for customers who signed in to Spotlight Cloud using Spotlight Enterprise versions earlier than 12.2. | ENT-217
