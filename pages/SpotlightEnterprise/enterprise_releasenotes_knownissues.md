...
**Manage access to Spotlight connections.** The Spotlight Client can add an existing connection although it is in the blacklist. <br><br> *Workaround:* Restart Client the added duplicate connection will be cleared, do not attempt to create the connection. | SOSSE-8189     
