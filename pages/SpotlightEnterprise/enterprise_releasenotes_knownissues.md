...
Spotlight Clients installed on Windows 10 - Dependent on the version of your Windows 10 operating system you may experience compatibility issues while using the Spotlight Overview page "What's This?" helper to investigate raised alarms. For example, the Spotlight Client may crash. To resolve such problems, run the Spotlight Client in compatibility mode for Windows 8. Click here for instructions: (https://support.quest.com/kb/230547)[https://support.quest.com/kb/230547]. | SOSSE-6499
